...
contextBridge.exposeInMainWorld('shelf', {
  ...
  shareCreate: (eggId: string) => invoke('shelf:shareCreate', eggId),
  shareImport: (code: string) => invoke('shelf:shareImport', code),
  copyText: (text: string) => invoke('shelf:copyText', text),
  saveShareImage: (pngDataUrl: string, name: string) => invoke('shelf:saveShareImage', pngDataUrl, name),
